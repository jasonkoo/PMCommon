...
public class HitDataEntry extends UserDataEntry {
	...
	public String toString() {
		...
		sb.append(result);
		sb.append(SEPARATOR);
		String hitTimeStr = TimeUtils.dateToString(hitTime, TimeUtils.DATE_TIME_PATTERN);
...
//		sb.append(result);
//		sb.append(SEPARATOR);
//		String hitTimeStr = TimeUtils.dateToString(hitTime, DATE_TIME_PATTERN);
//		sb.append(hitTimeStr);
//		sb.append(SEPARATOR);
//
...
//				de.pid = cols[1];
//				de.result = cols[2];
//				de.hitTime = TimeUtils.stringToDate(cols[3], DATE_TIME_PATTERN);
//
...
//					de.createDate = TimeUtils.stringToDate(cols[11],
//							DATE_TIME_PATTERN);
//				}
...
//					de.modifyDate = TimeUtils.stringToDate(cols[21],
//							DATE_TIME_PATTERN);
//				}
