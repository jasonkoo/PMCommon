...
//
//			// Open a stream
//			bis = new Base64_EXT.InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)), Base64_EXT.DECODE);
//
//			// Read until done
...
//	} // end decodeFromFile
	...
	public static String encodeFromFile(String filename) throws java.io.IOException {
		...
		try {
			...
			// Open a stream
			bis = new Base64_EXT.InputStream(new java.io.BufferedInputStream(new java.io.FileInputStream(file)), Base64_EXT.ENCODE);
...
//	} // end decodeFileToFile
	...
	/**
	 * A {@link Base64_EXT.InputStream} will read data from another
	...
	public static class InputStream extends java.io.FilterInputStream {
		...
		/**
		 * Constructs a {@link Base64_EXT.InputStream} in either ENCODE or
		 * DECODE mode.
		 * <p>
		 * Valid options:
		 * 
	...
	/**
	 * A {@link Base64_EXT.OutputStream} will write data to another
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		/**
		 * Constructs a {@link Base64_EXT.OutputStream} in either ENCODE or
		 * DECODE mode.
		 * <p>
		 * Valid options:
		 * 
